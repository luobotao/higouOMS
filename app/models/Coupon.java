...
public class Coupon implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3060648708834058610L;
	...
	public String getCouponpic() {
		...
		String domain = Configuration.root().getString("domain_dev","http://ht2.neolix.cn");
		if(IsProduct){
			domain = Configuration.root().getString("domain_product","http://ht.neolix.cn");
		}
