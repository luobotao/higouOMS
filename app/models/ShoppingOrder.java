...
public class ShoppingOrder implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4837314707531206800L;
	...
	@Column(nullable = false, columnDefinition = "tinyint(4) unsigned NOT NULL DEFAULT '0'")
	private int paystat;// 20服务端返回成功 stat0(0, "未支付"), stat10(10, "支付异常"), stat20(20, "支付成功");
	...
	private int status;//DELETE(-99, "已删除"), NOPAY(0, "未支付"), WAITTODELIVER(1, "已支付(待发货)"), DELIVERED(
//			2, "已发货"), END(3, "已完成"), CANCEL(5, "已取消"), REMAINPAY(20,
//			"尾款支付");
	private Double goods_fee;
	private Double domestic_fee;
	private Double foreignfee;	//运费
	...
	private String usebalance;	//钱包
	
	private String usewallet;	//是否使用钱包，使用则为1
