...
public class User implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7208931981065756573L;
	...
	@Column(name="`active`",columnDefinition = "tinyint(1) unsigned NOT NULL DEFAULT '1' ")
	private int active;//1登录状态 0未登录
	@Column(name="`date_add`")
	@Temporal(TemporalType.TIMESTAMP)
	private Date date_add;//注册时间
	@Column(name="`date_upd`")
	@Temporal(TemporalType.TIMESTAMP)
	private Date dateUpd;//登录时间
	private String usid;
	...
	@Column(columnDefinition="int(11) DEFAULT '1'")
	private Long fromUid;//用户来源ID 指的是`user`表下的uid
	@Column(columnDefinition="int(11) DEFAULT '1'")
	...
	@Column(name="postmanid",columnDefinition = "varchar(64) DEFAULT '' ")
	private String postmanid;//与棒棒糖绑定的快递员ID
	@Column(name="wxticket",columnDefinition = "varchar(64) DEFAULT '' ")
	private String wxticket;//在微信中生成的二维码
	
	@Column(name="qrcode",columnDefinition = "varchar(255) DEFAULT '' ")
	private String qrcode;//在微信中生成的二维码在OSS中存储的地址
