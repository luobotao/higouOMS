...
public class PadChannelPro  implements Serializable{
	...
	private String typFlag;//0：代言商品  1：代言Banner  2：频道  3：4图

	@Column(name="`typCount`",columnDefinition = "int(2) DEFAULT -1 ")
	private int typCount;//4图即为4,*图即为*
	...
	public int getTypCount() {
		return typCount;
	}
	public void setTypCount(int typCount) {
		this.typCount = typCount;
	}
