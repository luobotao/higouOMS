...
public class Parcels implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5636586535523213483L;
	...
	private Integer status;//自营已发货11 参考Constants.WaybillStatus
	...
	@Column(nullable = false, columnDefinition = "DEFAULT '0' ")
	private double bbt_print;
	@Column(columnDefinition = "DEFAULT '' ")
	private String remark;
	@Column(columnDefinition = "int(5) DEFAULT 0 ")
	private Integer checkStatus;//联营结算状态 参考Constants.ParcelCheckStatus 0 未结束 1 已申请 2已确认
	
	@Transient
	private List<Product> productList;
	@Transient
	private String currencyName;		//货币符号
	...
	public String getBbtid() {
		return bbtid;
	}

	public void setBbtid(String bbtid) {
		this.bbtid = bbtid;
	}
	...
	public void setBbt_print(double bbt_print) {
		this.bbt_print = bbt_print;
	}
